...
class Post(models.Model):
    ...
    seen = models.ManyToManyField(User,verbose_name="görülen sany", blank=True, related_name="gorulen")
    like = models.ManyToManyField(User,verbose_name="like sany", blank=True)
